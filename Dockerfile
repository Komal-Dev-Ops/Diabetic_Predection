...
# Create the `komal` environment and install dependencies
RUN conda create -n komal python=3.9 -y && \
    conda run -n komal pip install --no-cache-dir -r requirements.txt
